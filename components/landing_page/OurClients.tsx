...
const OurClients = () => {
  return (
    <section className="w-full bg-neutral-900 py-10 flex flex-col items-center text-center">
      <h3 className="uppercase text-sm tracking-[0.3em] text-gray-400 mb-10">
        Our Clients
      </h3>

      <div className="flex max-lg:flex-col flex-wrap justify-center gap-10 md:gap-20 text-gray-300 text-xl md:text-2xl font-serif">
